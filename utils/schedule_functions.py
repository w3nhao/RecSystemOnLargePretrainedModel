...
def get_lr_scheduler_function(scheduler_type,
    ...
    if scheduler_type == 'linear':
        return linear_schedule_with_warmup_function(num_warmup_steps,
                                                    num_training_steps)
    elif scheduler_type == 'cosine':
        return cosine_schedule_with_warmup_function(num_warmup_steps,
                                                    num_training_steps,
                                                    num_cycles)
    elif scheduler_type == 'cosine_with_hard_restarts':
        return cosine_schedule_with_hard_restarts_function(
            num_warmup_steps, num_training_steps, num_cycles)
    elif scheduler_type == 'polynomial_decay':
        return polynomial_decay_schedule_with_warmup_function(
...
def cosine_schedule_with_warmup_function(num_warmup_steps,
                                         num_training_steps,
                                         num_cycles=0.5):
...
def cosine_schedule_with_hard_restarts_function(num_warmup_steps,
                                                num_training_steps,
                                                num_cycles=0.5):
...
def polynomial_decay_schedule_with_warmup_function(num_warmup_steps,
                                                   num_training_steps,
                                                   lr_init=1e-4,
                                                   lr_end=1e-7,
                                                   power=1.0):
